...
{
	public class S_SET005Repository(ISaveDataRepository<S_SET005Model> saveDataRepository)
	{
		private readonly ISaveDataRepository<S_SET005Model> _saveDataRepository = saveDataRepository;

		public string SaveData(BaseModel.SaveObj<S_SET005Model> saveData, DbConnection connection, DbTransaction transaction, bool ignoreUpdtdt = false)
		{
			BeforeSaveData();

			var saveDataParams = new SaveDataParams<S_SET005Model>
			{
				...
				DELETEQUERY = S_SET005Query.S_SET005_DELETE_1(),
