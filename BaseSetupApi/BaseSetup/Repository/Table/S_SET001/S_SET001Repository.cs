...
namespace BaseSetup.Repository.Table.S_SET001
{
	public class S_SET001Repository(ISaveDataRepository<S_SET001Model> saveDataRepository)
	{
		private readonly ISaveDataRepository<S_SET001Model> _saveDataRepository = saveDataRepository;

		public string SaveData(BaseModel.SaveObj<S_SET001Model> saveData, DbConnection connection, DbTransaction transaction, bool ignoreUpdtdt = false)
		{
			BeforeSaveData();

			var saveDataParams = new SaveDataParams<S_SET001Model>
			{
