...
namespace BaseSetup.Repository.Table.S_SET002
{
	public class S_SET002Repository(ISaveDataRepository<S_SET002Model> saveDataRepository)
	{
		private readonly ISaveDataRepository<S_SET002Model> _saveDataRepository = saveDataRepository;

		public string SaveData(BaseModel.SaveObj<S_SET002Model> saveData, DbConnection connection, DbTransaction transaction, bool ignoreUpdtdt = false)
		{
			BeforeSaveData();

			var saveDataParams = new SaveDataParams<S_SET002Model>
			{
